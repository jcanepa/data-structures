...
class TestHashTable(unittest.TestCase):
    ...
    def test_size(self):
        """
        A default HashTable has a size attribute that is 20.
        """
        h = HashTable()
        self.assertEqual(20, h.size)
    ...
    def test_delete(self):
        """
        Deleting an element with a given key removes it from the list.
        """
        h = HashTable(5)
        h['spam'] = 'eggs'
        h.delete('spam')
